...
func (n *PostgresSelectQuery) AbstractionsReviewsCommentsGetSelectQuery(ctx context.Context, abstraction map[string]any, abstractionParentPath string) (*SelectQuery, error) {
