...
func (n *PostgresSelectQuery) AbstractionsGetSelectQuery(ctx context.Context, abstraction map[string]any, abstractionParentPath string) (*SelectQuery, error) {
	quoteColumns := true
	...
	if value, err := n.extractChildMetadataModel(abstraction, abstractionsDirectoryGroupsIDJoinAbstractionsDirectoryGroups); err != nil {
	...
	if value, err := n.extractChildMetadataModel(abstraction, storageFilesIDJoinStorageFiles); err != nil {
	...
	if value, err := n.extractChildMetadataModel(abstraction, abstractionsJoinAbstractionsAuthorizationIDs); err != nil {
