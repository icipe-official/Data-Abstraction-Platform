...
type RouteHomeWebsiteService interface {
	...
	ServiceGetHomePageHtml(ctx context.Context, websiteTemplate WebsiteTemplates, openid OpenID, partialRequest bool, partialName string, iamCredential *intdoment.IamCredentials) (*string, error)
}
