...
type storageDrivesGroupsRepository struct {
...
func StorageDrivesGroupsRepository() storageDrivesGroupsRepository {
	return storageDrivesGroupsRepository{
		RepositoryName: "storage_drives_groups",
