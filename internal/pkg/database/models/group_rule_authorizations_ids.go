...
type groupRuleAuthorizationsIDsTable struct {
	TableName string
...
func GroupRuleAuthorizationsIDsTable() groupRuleAuthorizationsIDsTable {
	return groupRuleAuthorizationsIDsTable{
		TableName: "group_rule_authorizations_ids",
