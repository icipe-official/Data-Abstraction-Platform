...
type metadataModelsAuthorizationIDsTable struct {
	TableName string
...
func MetadataModelsAuthorizationIDsTable() metadataModelsAuthorizationIDsTable {
	return metadataModelsAuthorizationIDsTable{
		TableName: "metadata_models_authorization_ids",
