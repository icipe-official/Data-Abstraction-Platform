...
type abstractionsReviewsTable struct {
	TableName string
...
func AbstractionsReviewsTable() abstractionsReviewsTable {
	return abstractionsReviewsTable{
		TableName: "abstractions_reviews",
