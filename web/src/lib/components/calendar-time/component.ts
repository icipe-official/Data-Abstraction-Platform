...
class Component extends LitElement {
	...
	protected render(): unknown {
		return html`
			<drop-down .showdropdown=${this._showCalendarTimeOptions}>
								...
								case CalendarTimeTab.TIME:
									return html`
										<div class="self-center sm:w-[50%] max-sm:w-full flex">
											...
											<div class="flex-1 flex flex-col">
												<button
													class="rounded-tl-none rounded-tr-lg rounded-b-none btn ${this.color === Theme.Color.PRIMARY ? 'btn-primary' : this.color === Theme.Color.SECONDARY ? 'btn-secondary' : this.color === Theme.Color.ACCENT ? 'btn-accent' : 'bg-black text-white'} h-fit${this._minute !== null &&
													this._minute >= 59
														? ' btn-disabled'
														: ''}"
												...
												<button
													class="rounded-bl-none rounded-br-lg rounded-t-none btn ${this.color === Theme.Color.PRIMARY ? 'btn-primary' : this.color === Theme.Color.SECONDARY ? 'btn-secondary' : this.color === Theme.Color.ACCENT ? 'btn-accent' : 'bg-black text-white'} h-fit${this._minute !== null &&
													this._minute <= 0
														? ' btn-disabled'
														: ''}"
													@click=${() => this._handleDateTimeInput(null, null, null, null, `${this._minute !== null ? this._minute - 1 : -1}`)}
