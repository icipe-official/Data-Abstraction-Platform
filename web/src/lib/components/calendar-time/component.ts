												...
												return html`
													<div class="flex flex-col space-y-1 w-full">
														<div class="flex w-full">
															<button
																class="rounded-bl-lg rounded-tl-lg rounded-br-none rounded-tr-none btn ${this.color === Theme.Color.PRIMARY ? 'btn-primary' : this.color === Theme.Color.SECONDARY ? 'btn-secondary' : 'btn-accent'} flex-1 h-fit${this._maxYearToDisplay !== null &&
																this._maxYearToDisplay - 24 <= 1000
																	? ' btn-disabled'
																	: ''}"
																@click=${(e: Event) => {
																	e.preventDefault()
															...
															>
																<iconify-icon
																	...
																	style="color: ${this.color === Theme.Color.PRIMARY ? Theme.Color.SECONDARY_CONTENT : this.color === Theme.Color.SECONDARY ? Theme.Color.ACCENT_CONTENT : Theme.Color.PRIMARY_CONTENT};"
																	width=${Misc.IconifySize()}
																	height=${Misc.IconifySize()}
																></iconify-icon>
															</button>
															<button
																class="rounded-bl-none rounded-tl-none rounded-br-lg rounded-tr-lg btn ${this.color === Theme.Color.PRIMARY ? 'btn-primary' : this.color === Theme.Color.SECONDARY ? 'btn-secondary' : 'btn-accent'} flex-1 h-fit"
																@click=${(e: Event) => {
																	e.preventDefault()
																	this._generateYearsToDisplay(true)
																}}
												...
												return html`
													<div class="self-center sm:w-[50%] max-sm:w-full flex">
														<div class="flex-1 flex flex-col">
															<button
																class="rounded-tl-lg rounded-tr-none rounded-b-none btn ${this.color === Theme.Color.PRIMARY ? 'btn-primary' : this.color === Theme.Color.SECONDARY ? 'btn-secondary' : 'btn-accent'} h-fit${this._hour !== null && this._hour >= 23 ? ' btn-disabled' : ''}"
															...
															<button
																class="rounded-bl-lg rounded-br-none rounded-t-none btn ${this.color === Theme.Color.PRIMARY ? 'btn-primary' : this.color === Theme.Color.SECONDARY ? 'btn-secondary' : 'btn-accent'} h-fit${this._hour !== null && this._hour <= 0 ? ' btn-disabled' : ''}"
																@click=${() => this._handleDateTimeInput(null, null, null, `${this._hour !== null ? this._hour - 1 : -1}`, null)}
																.disabled=${this.disabled}
															>
																<iconify-icon
														...
														<div class="flex-1 flex flex-col">
															<button
																class="rounded-tl-none rounded-tr-lg rounded-b-none btn ${this.color === Theme.Color.PRIMARY ? 'btn-primary' : this.color === Theme.Color.SECONDARY ? 'btn-secondary' : 'btn-accent'} h-fit${this._minute !== null && this._minute >= 59 ? ' btn-disabled' : ''}"
															...
															<button
																class="rounded-bl-none rounded-br-lg rounded-t-none btn ${this.color === Theme.Color.PRIMARY ? 'btn-primary' : this.color === Theme.Color.SECONDARY ? 'btn-secondary' : 'btn-accent'} h-fit${this._minute !== null && this._minute <= 0 ? ' btn-disabled' : ''}"
																@click=${() => this._handleDateTimeInput(null, null, null, null, `${this._minute !== null ? this._minute - 1 : -1}`)}
																.disabled=${this.disabled}
															>
																<iconify-icon
