							...
							if (this._appContext.appcontext?.targetjoindepth && this._appContext.appcontext?.targetjoindepth > 0) {
								return html`
									<input
										...
										type="search"
										placeholder="Search iam group authorizations..."
										...
										<div class="flex justify-evenly flex-wrap gap-8">
											<button class="link link-hover min-h-fit h-fit min-w-fit w-fit flex flex-col justify-center">
												...
												${(() => {
													...
													return html`<div>Create New Group Rule Authorzations</div>`
												})()}
											</button>
											<button class="link link-hover min-h-fit h-fit min-w-fit w-fit flex flex-col justify-center" @click=${() => (this._showQueryPanel = true)}>
												...
												${(() => {
													...
													return html`<div>Search Group Rule Authorzations</div>`
												})()}
											</button>
											<button class="link link-hover min-h-fit h-fit min-w-fit w-fit flex flex-col justify-center" @click=${() => (this._showQueryPanel = true)}>
												<div class="flex gap-x-1 self-center">
												...
												${(() => {
													...
													return html`<div>Delete Group Rule Authorzations</div>`
												})()}
											</button>
										</div>
									</div>
