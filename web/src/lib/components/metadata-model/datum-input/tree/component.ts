							...
							<div class="flex flex-col">
								${this._fieldsGroupsKeysSearchResults.map((fgKey) => {
									...
									if (MetadataModel.IsGroupFieldsValid(fieldgroup)) {
										return html` <metadata-model-datum-input-tree class="pt-1 pb-1" .scrollelement=${this.scrollelement} .color=${Theme.GetNextColorA(this.color)} .fieldgroup=${fieldgroup} .updatemetadatamodel=${this.updatemetadatamodel} .showgroupfields=${false}></metadata-model-datum-input-tree> `
									}
